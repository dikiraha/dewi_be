@extends('website.layouts.main', ['title' => 'List Department'])

@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            <div class="d-flex justify-content-between">
                <h5 class="card-header">List Department</h5>
                <a href="{{ route('website.department.create') }}" class="btn btn-success" style="margin: 1.25rem;">Create</a>
            </div>
    ...
    <script>
        $(document).ready(function() {
            var table = $('#app_table').DataTable({
                ...
                'orderable': true,
                ajax: {
                    url: "{{ route('website.department.list_ajax') }}",
                },
                columns: [{
                        data: null,
                        orderable: true,
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            return `<div class="text-center">
                                        <a href="{{ url('department/edit/') }}/${row.uuid}" class="btn btn-sm btn-primary">Edit</a>
