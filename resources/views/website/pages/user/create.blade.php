                        ...
                        <form method="post" action="{{ route('website.user.store') }}" id="myForm"
                            ...
                            <div class="form-floating form-floating-outline mb-4">
                                <input type="text" class="form-control" id="nik" name="nik"
                                    value="{{ old('nik') }}" placeholder="000000" required autofocus maxlength="6"
                            ...
                            <div class="form-floating form-floating-outline mb-4">
                                <input type="text" class="form-control" id="name" name="name"
                                    value="{{ old('name') }}" placeholder="Nama Lengkap" onkeyup="formatFullName(this)"
                                    required>
                            ...
                            <div class="form-floating form-floating-outline mb-4">
                                <input type="text" class="form-control" id="phone" name="phone"
                                    value="{{ old('phone') }}" placeholder="081234567890" required autofocus maxlength="15"
                                    oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                                ...
                                <select class="form-select form-control" id="department" name="department[]"
                                    ...
                                    @foreach ($departments as $department)
                                        <option value="{{ $department->id }}"
                                            {{ collect(old('department'))->contains($department->id) ? 'selected' : '' }}>
                                            {{ $department->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-floating form-floating-outline mb-4">
                                <select class="form-select form-control" id="role" name="role" aria-label="Select"
                                    required>
                                    <option value="" {{ old('role') == '' ? 'selected' : '' }}>-- Select --</option>
